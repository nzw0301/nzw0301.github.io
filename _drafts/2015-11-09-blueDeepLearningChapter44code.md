...
データは例によって夢野久作の([オンチ](http://www.aozora.gr.jp/cards/000096/files/2122_21847.html))という作品を使います．
...
![nn]({{ site.url }}/assets/img/nn_err_rate.svg)

学習回数`400`，学習率`0.2`で固定し，隠れ層をいじってみます．
![nn]({{ site.url }}/assets/img/nn_hidden.svg)

学習率`0.2`と隠れ層を固定し，SGD を使います．ミニバッチによる変化を見ています．

![nn]({{ site.url }}/assets/img/nn_minibatch.svg)
